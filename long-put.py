...
class LongPutFrame(Frame):
    '''frame for a game of Long put'''

    def __init__(self,master,name):
        '''LongPutFrame(master,name) -> LongPutFrame
        creates a new Long Put frame
    ...
    def roll(self):
        ...
        if self.dice[self.gameround].get_top() == -1:
            ...
            self.scoreLabel['text'] = 'FOULED ATTEMPT: GAME OVER'
            return
...
root = Tk()
# play the game
LongPutFrame(root, input('Enter Name: '))
root.mainloop()
